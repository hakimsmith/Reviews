...
namespace Reviews.Migrations
{
    ...
    [Migration("20190621193723_ChangedMovieReviewRelationship")]
    partial class ChangedMovieReviewRelationship
    {
            ...
            modelBuilder.Entity("Reviews.Model.Genre", b =>
                {
                    ...
                    b.HasData(
                        new { GenreId = 1, GenreName = "Sci Fi" },
                        new { GenreId = 2, GenreName = "Slasher" },
                        new { GenreId = 3, GenreName = "Supernatural" }
                    );
                });
            ...
            modelBuilder.Entity("Reviews.Model.Movie", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { MovieId = 3, Description = "2004 American psychological horror-thriller filmed and directed by James Wan.", GenreId = 2, ImageUrl = "Saw.jpg", Title = "Saw" },
